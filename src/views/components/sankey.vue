...
export default {
  ...
  methods:{
    drawSankey(data, id) {
        ...
        // Color
        const causes = ["Middle East & North Africa","South Asia","South America","Sub-Saharan Africa",
                        ...
                        // method
                        "Bombing/Explosion","Armed Assault","Assassination","Hostage Taking (Kidnapping)",
        ...
        const color = d3.scaleOrdinal()
            ...
            .range(["#e6ab02","#1b9e77","#d95f02","#66a61e",
              ...
              "#076d2e","#076d2e","#076d2e","#076d2e","#076d2e",
              "#076d2e","#076d2e","#076d2e","#076d2e","#076d2e"
              ])   
        ...
        const h = d3.scaleLinear()
                    ...
                    .rangeRound([0, nodeHeight*2.32]); // MAGIC NUMBER TO MAKE EVERYTHING SCALE
...
*/
        ...
        .attr("class", function(d) { return "myLink sankeyLink-" + d.source.name.replaceAll(" ","-").replaceAll("/","-").replaceAll("&","-")})
        ...
        .append('path')
        .attr('d', sankeyLinkHorizontal())
        .attr("class", function(d) { return "myLink sankeyLinkTarget-" + d.target.name.replaceAll(" ","-").replaceAll("/","-").replaceAll("&","-")})
        // .attr("class", function(d) { return "myLink sankeyLinkTarget-" + d.target.name })
        .attr('stroke', (d) =>
            !ENABLE_LINKS_GRADIENTS ? color(d.source.name) : `url(#${d.uid})`
        )
